...
const jobs=[
  {
    path:'documents/015-polytypic-thinking/en/index.html', number:'015',
  ...
  {
    path:'documents/015-polytypic-thinking/ua/index.html', number:'015',
  ...
  {
    path:'documents/016-right-to-a-first-chance/en/index.html', number:'016',
    eyebrow:'AI READER LAB', title:'Take this essay to your AI',
  ...
  {
    path:'documents/016-right-to-a-first-chance/ua/index.html', number:'016',
    eyebrow:'ШІ-ЛАБОРАТОРІЯ ЧИТАЧА', title:'Візьми цю статтю у свій ШІ',
