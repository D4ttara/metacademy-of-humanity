...
patch('documents/017-human-ai-what-or-we/ua/index.html', s=>s,[
  ['017 v1.1 plaque',s=>s.includes('Document 017') && s.includes('v1.1')],
  ['017 v1.1 Markdown',s=>s.includes('METACADEMY_DOCUMENT_017_HUMAN_AI_WHAT_OR_WE_UA_v1.1.md')],
  ['017 HTML+MD only',s=>!s.includes('UA_v1.0_PUBLIC.pdf') && !s.includes('UA_v1.0_PUBLIC.epub') && !s.includes('UA_v1.0_PUBLIC.docx')],
  ['017 no broken cover',s=>!s.includes('HUMAN_AI_WHAT_OR_WE_COVER_UA_v1.0.jpg')]
]);

console.log('MANIFESTO_PUBLIC_SURFACES=PASS current_manifest=UA,EN document_017=UA_v1.1 formats=HTML,MD');
