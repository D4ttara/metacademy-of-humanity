...
build_one(){
  ...
  pdftotext "$pdf" - | grep -Fq "MET[Ȧ]CADEMY OF HUMANITY" || { echo "Manifest title missing in $pdf"; exit 1; }
...
build_one "$BASE/v1.0/META_A_CADEMY_MANIFEST_V1.0.md" "META_A_CADEMY_MANIFEST_V1.0" "uk-UA" "MET[Ȧ]CADEMY OF HUMANITY · Маніфест незавершеності знання · v1.0"
...
echo "MANIFEST_FORMAT_BUILD=PASS editions=5 formats=PDF,EPUB,DOCX"
