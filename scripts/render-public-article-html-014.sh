...
for lang in en ua; do
  upper="${lang^^}"; html="documents/014-right-to-see-the-consequence/$lang/index.html"; md="documents/014-right-to-see-the-consequence/METACADEMY_DOCUMENT_014_RIGHT_TO_SEE_THE_CONSEQUENCE_${upper}_v1.0.md"; fragment="$TMP/$lang.html"
...
if '<ul' in h or '<ol' in h: raise SystemExit('forbidden list markup in Document 014')
hp.write_text(h,encoding='utf-8')
PY
  echo "STATIC_ARTICLE_RENDER=PASS doc=014 lang=$lang lists=ZERO"
done
