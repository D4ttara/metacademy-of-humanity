...
for(const required of [SITE+'/',SITE+'/uk/',SITE+'/manifesto/',SITE+'/documents/',SITE+'/discover/',SITE+'/books/',SITE+'/uk/books/']) must(urls.has(required),`AI index missing ${required}`);
