...
for (const token of ["life-as-organization", "when-science-reaches-a-plateau", "sha256:"]) if (!registry.includes(token)) throw new Error(`Publication registry missing ${token}`);
console.log(`PUBLIC_SITE_VERIFY=PASS files=${publicFiles.length} routes=7 language_shell=EN_RU private_markers=0 domains=13`);
